...
Art and sound effects by [Kenney](https://kenney.nl) — Desert Shooter Pack, CC0. See `assets/KENNEY-LICENSE.txt`. The music is a lo-fi sequencer synthesized in the browser with the Web Audio API — electric piano, pad, brushed kit, tape wobble and vinyl crackle, a different theme for every place. There are no audio files for it.
